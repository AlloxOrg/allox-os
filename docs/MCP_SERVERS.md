# AIO Sandbox MCP Server 盘点

> 对应 [ROADMAP.md](../ROADMAP.md) 阶段 2.6.1。  
...
以下来自 [AIOsandbox/README.md](../../AIOsandbox/README.md)；**是否全部启用取决于镜像 tag / `mcp-servers.json`**。
...
将结果与本文对照；有差异时更新本文并同步 [PHASE2_TESTING.md](./PHASE2_TESTING.md)。

## 参考

- [AIO 浏览器 MCP 工具列表](../../AIOsandbox/website/docs/zh/examples/browser.md)
- [AIO MCP 集成文档](../../AIOsandbox/website/docs/zh/guide/basic/mcp.md)
- [OpenAPI `/v1/mcp/*`](../../AIOsandbox/website/docs/public/v1/openapi.json)
