...
构建完成后按 [PHASE3_TESTING.md](./PHASE3_TESTING.md) 执行验收。
...
- [AIO Custom Images 官方文档](../../AIOsandbox/website/docs/en/blog/announcing-0.mdx)（Extension and Ecosystem → Custom Images）
- [ROADMAP.md](../ROADMAP.md) 阶段 3
- [CODE_INTERPRETER.md](./CODE_INTERPRETER.md)（非 AIO 轻量沙箱评估）
