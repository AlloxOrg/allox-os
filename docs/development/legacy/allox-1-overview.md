# Allox 1.x 项目能力总结（历史归档）

> 本文描述的是“每个任务一个 sandbox”的 1.x 逻辑，仅作为历史材料保留。
> Allox 2.0 当前架构以外层 Kata VM 和 VM 内 Agent/Session workspace 为准，
> 参见 [`../../architecture/overview.md`](../../architecture/overview.md)。
