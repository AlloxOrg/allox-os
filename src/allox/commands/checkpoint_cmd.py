"""Create, inspect, schedule, and restore OpenSandbox checkpoints."""
...
from allox.checkpoint import create_checkpoint, latest_ready_snapshot, list_snapshots, snapshot_to_dict
...
def checkpoint_group(ctx: click.Context) -> None:
    """Save and restore sandbox filesystem checkpoints."""
