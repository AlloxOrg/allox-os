"""Optional LangChain integration for Allox turn checkpoints.
...
from allox.turn_lifecycle import TurnCheckpointLifecycle, WorkspaceRPC
...
class LangChainTurnCheckpointPlugin:
    """ANOLISA-style lifecycle plugin for a LangChain Agent runnable."""
