"""Allox 2.0 operator CLI entry point."""
...
from allox.cli.commands.config import config_group
from allox.cli.commands.exec import run_command
from allox.cli.commands.files import file_group
from allox.cli.commands.runtime import aio_group
from allox.cli.commands.vm import sandbox_group
from allox.cli.commands.vm_checkpoint import checkpoint_group
from allox.cli.commands.vm_selection import session_group
from allox.cli.commands.workspace import workspace_group
...
BANNER = r"""[bold cyan]
 ...
 /_/   \_\_|_|\___/|___/_/\_\\__,_|\__, |\___/
                                   |___/
[/]  [dim]v{version} — Kata VM + Agent/Session Workspaces[/]
"""
...
def cli(
    ...
    """Allox — one Kata VM, isolated Agent/Session workspaces inside."""
...
# `vm` is the Allox 2.0 name. `sandbox` remains as a CLI compatibility alias.
cli.add_command(sandbox_group, name="vm")
