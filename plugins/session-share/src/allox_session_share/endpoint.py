"""Per-Session share endpoints outside Bubblewrap; no Agent-facing admin token."""
...
if hasattr(socketserver, "UnixStreamServer"):
    class ShareServer(socketserver.ThreadingMixIn, socketserver.UnixStreamServer):
        daemon_threads = True
else:  # pragma: no cover - the plugin activates only in the Linux Guest
    class ShareServer:
        def __init__(self, *args, **kwargs):
            raise WorkspaceError("Session share endpoints require Unix-domain sockets")
